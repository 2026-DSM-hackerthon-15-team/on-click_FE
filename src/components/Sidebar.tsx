...
function Sidebar() {
  ...
  return (
    <aside className="box-border flex w-60 shrink-0 min-h-svh flex-col border-r border-[#e0e0e0] bg-[#f5f5f7] p-4">
      ...
      {user && (
        <div className="mt-4 flex items-center justify-between gap-2 border-t border-[#e0e0e0] px-3 pt-4">
          <NavLink
            to="/mypage"
            className={({ isActive }) =>
              `flex min-w-0 flex-1 items-center gap-2 rounded-lg py-1 text-[14px] text-[#1d1d1f] no-underline transition-colors hover:text-[#0066cc] ${
